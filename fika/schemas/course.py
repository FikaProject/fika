...
class CourseSchema(DCMetadataSchema, BaseSchema):
    title = colander.SchemaNode(colander.String(),
                                description = _(u"The title of the course."))
    description = colander.SchemaNode(colander.String(),
                                      description = _(u"A short description of the course."),
    ...
    introduction = colander.SchemaNode(colander.String(),
                               description=_(u"Describe who the course is for, why the course is relevant, and give a short example of a problem the course will help in solving."),
                               widget = deform.widget.RichTextWidget(),
                               missing = u"")
    image_data = colander.SchemaNode(deform.FileData(),
                                     description=_(u"(Optional) An image that will be shown next to the description."),
                                     missing = None,
                                     title = _(u"Image"),

...
#             icon = 'eye-open', view_name = '', priority = 2) 
#@view_action('actions', 'edit', permission = security.EDIT, title=_(u"Edit"),
#             icon = 'edit', view_name = 'edit', schema_required = 'edit', priority = 3)
#@view_action('actions', 'delete', permission = security.DELETE, title=_(u"Delete"),
#             icon = 'remove-circle', view_name = 'delete', schema_required = 'delete', priority = 5)
#@view_action('actions', 'order', permission = security.EDIT, title=_(u"Order"),
#             icon = 'sort-by-attributes', view_name = 'order', interface = ICourseModule, priority = 4)
